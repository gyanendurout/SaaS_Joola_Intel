    ...
    for item in items:
        ...
        if handle and handle not in seen:
            ...
            profiles.append({
                ...
                "likes":       author.get("heart") or author.get("likesCount"),
        ...
        videos.append({
            ...
            "posted_at":    item.get("createTime") or item.get("createdAt"),
            "hashtags":     [t.get("name") or t for t in (item.get("hashtags") or []) if t],
